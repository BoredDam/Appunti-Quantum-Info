...
\textbf{Passo Induttivo}: Supponiamo che l'affermazione sia vera fino all'($i-1$)-esimo passo.
...
affinché: 
$$
l_i = \log_{2}\frac{1}{q_i}  - \log_{2} z
$$
...
La lunghezza attesa è minimizzata ed è uguale all'entropia se e solo se le lunghezze delle codeword sono uguali all'Informazione di Shannon:
$$
